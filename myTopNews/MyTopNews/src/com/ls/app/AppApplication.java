...
//	public List<Map<Integer, List<NewsEntity>>> newsEntityList;
//	private List<ChannelItem> userChannelItems;
	...
	public void onCreate() {
		...
		// userChannelItems = ChannelManage.getManage(getSQLHelper())
		// .getUserChannel();
//		new Work().start();
	}
...
//		Map<Integer, List<NewsEntity>> map = new HashMap<Integer, List<NewsEntity>>();
//
//		@Override
//		public void run() {
//			// TODO Auto-generated method stub
//			for (int i = 0; i < userChannelItems.size(); i++) {
//				int id = userChannelItems.get(i).getId();
//				Constants constants = new Constants();
//				newsList = constants.getNewsList(id);
//				map.put(id, newsList);
//				newsEntityList.add(map);
//			}
...
//	public List<NewsEntity> getNewsEntityList(int i) {
//		if (newsEntityList != null) {
//			return newsEntityList.get(i).get(userChannelItems.get(i).getId());
//		}
//		return null;
//	}
